...
def register():
    ...
    Label(register_screen, text='Please Enter Your Details Below To Register', font=('Calibre', 12)).grid(row=0,
                                                                                                          sticky=N,
                                                                                                          pady=10)
    ...
    for name in all_accounts:
        ...
        if name == login_name:
            ...
            if login_password == password:
                ...
                Button(account_dashboard, text='Personal Details', font=('Calibre', 12), width=30,
                       command=personal_details).grid(row=2, sticky=N, padx=10)
                Button(account_dashboard, text='Deposit', font=('Calibre', 12), width=30, command=deposit).grid(row=3,
                                                                                                                sticky=N,
                                                                                                                padx=10)
                Button(account_dashboard, text='Withdraw', font=('Calibre', 12), width=30, command=withdraw).grid(row=4,
                                                                                                                  sticky=N,
                                                                                                                  padx=10)
...
def login():
    ...
    Button(login_screen, text='Login', font=('Calibre', 12), command=login_session, width=15).grid(row=3, sticky=W,
                                                                                                   pady=5, padx=5)



Label(master, text='BHU Bank LTD', font=('Calibre', 14)).grid(row=0, sticky=N, pady=10)
